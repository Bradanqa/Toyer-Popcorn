...
{
	Normal,
	Finalizing, // Начинаем удалять объект // Когда объект нужно удалять
	Finished // Когда объект нужно удалять
};
//-------------------------------------------------------------------------------------------------------------------------
class AFalling_Letter : public AGrafics_Object
{
public:
...
private:
	void Set_Brick_Letter_Color(bool is_switch_color, const AColor **front_color, const AColor **back_color);
