...
//-------------------------------------------------------------------------------------------------------------------------
void ABall_Set::Finish_Movement()
{
   int i;
...
//-------------------------------------------------------------------------------------------------------------------------
void ABall_Set::Advance(double max_speed)
{
   int i;
...
//-------------------------------------------------------------------------------------------------------------------------
void ABall_Set::Clear(HDC hdc, RECT& paint_area)
{
   int i;
...
//-------------------------------------------------------------------------------------------------------------------------
void ABall_Set::Draw(HDC hdc, RECT& paint_area)
{
   int i;
