...
const AColor AsConfig::Explosion_Dark_Orange(AsConfig::White_Color, AsConfig::Orange_Color, 0);
const AColor AsConfig::Explosion_Dark_Blue(AsConfig::White_Color, AsConfig::Blue_Color, 0);
